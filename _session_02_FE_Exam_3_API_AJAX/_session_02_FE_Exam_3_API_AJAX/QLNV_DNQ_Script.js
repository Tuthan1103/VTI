...
$(function () {
    ...
    $('#Main_Form_ID').submit(function () {
        ...
        $.post("https://64c005f50d8e251fd111d7bc.mockapi.io/Account", account,
...
function deleteAccount(Index) {
    ...
    if (confirm_del) {
        $.ajax({
            url: 'https://64c005f50d8e251fd111d7bc.mockapi.io/Account' + v_del_ID,
            type: 'DELETE',
...
function editAccount(Index) {
    ...
    $('#update_btn').click(function () {
        ...
        $.ajax({
            url: 'https://64c005f50d8e251fd111d7bc.mockapi.io/Account' + v_ID_ID,
            type: 'PUT',
            data: account,
            success: function (result) {
                // error
...
function getListEmployees() {
    ...
    $.get("https://64c005f50d8e251fd111d7bc.mockapi.io/Account", function (data, status) {
